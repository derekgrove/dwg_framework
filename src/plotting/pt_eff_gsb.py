...
def make_1d_pt_eff_comparison(hist1, 
                      hist2, 
                      name="default_name", 
                      title=None, 
                      plot_txt=None, 
    ...
    hist1_int = hist1.integrate("pt").integrate("eta").integrate("eta_long")
    hist2_int = hist2.integrate("pt").integrate("eta").integrate("eta_long")
